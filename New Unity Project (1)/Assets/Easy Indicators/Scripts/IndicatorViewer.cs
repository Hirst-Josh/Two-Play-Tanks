...
public class IndicatorViewer : MonoBehaviour
{
    ...
    public float DisableDistanceflag = 100;
    public bool DisableOnDistanceflag = true;
    public float DisableDistanceteam2 = 100;
    public bool DisableOnDistanceteam2 = true;
    public float DisableDistancePowerUp = 100;
    public bool DisableOnDistancePowerup = true;
    ...
    public static List<IndicatorTargetTeam2> TargetsTeam2 = new List<IndicatorTargetTeam2>();
    public static List<IndicatorTargetFlag> Targetsflag = new List<IndicatorTargetFlag>();
